...
/* `worstInsightBetween` and its severity ranking are gone with the scorer that
 * produced the grades. A week has no worst day to take, because no day is
 * graded — an insight is a sentence about the work, and it ranks nobody.
 */
                    ...
                    <TBody>
                      {view.weeks.map((w) => (
                        <TR key={w.week.index}>
                          ...
                          <TD>
                            {/* This instructor's own week, so they may ask for
                                it — INSTRUCTOR/WEEK is GENERATE in the matrix.
                                Nothing is generated by rendering: the cell is
                                empty until somebody presses the button in it. */}
                            <DayInsightCell
