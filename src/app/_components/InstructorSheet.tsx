...
const HEAD = "sticky top-0 z-20 bg-primary-subtle";
const DATE_COL = "sticky left-0 z-10";
const CORNER = "sticky left-0 top-0 z-30 bg-primary-subtle";
      ...
      <table className="w-full min-w-[1040px] border-separate border-spacing-0 text-sm">
        ...
        <thead>
          <tr>
            <th
              scope="col"
              className={`${CORNER} w-36 border-b border-r border-line px-4 py-3.5 text-left text-xs font-semibold leading-snug text-primary-text`}
            >
              Date
            </th>
            {COLUMNS.map((c) => (
              <th
                key={c.key}
                scope="col"
                className={`${HEAD} border-b border-line px-4 py-3.5 text-xs font-semibold leading-snug text-primary-text ${c.align}`}
              >
                {c.label}
              </th>
            ))}
